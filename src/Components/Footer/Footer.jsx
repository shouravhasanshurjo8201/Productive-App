    ...
    return (
        ...
        <footer className="bg-base-200 text-base-content rounded p-10">
            <div className="flex justify-between items-center border-b border-gray-400 p-2">
                <div>
                    <Link to="/" title="HERO.IO" className=" flex justify-around items-center gap-2 text-xl font-bold cursor-pointer"><img src={imgLogo} alt="Logo-img" className="h-8 w-8" /> HERO.IO</Link>
                </div>
                <div>
