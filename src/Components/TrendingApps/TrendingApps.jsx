...
const TrendingApps = ({appData , Loading}) => {
  return (
    <div className='bg-gray-100'>
        <div className='container mx-auto my-10 px-4 md:px-10'>
            ...
            {Loading? <LoadingPage></LoadingPage> : <div><div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 my-5'>
